...
double eval_objv(void) {
  ...
  objv += work.quad_804345917440[0]+work.quad_255575560192[0]+work.quad_896928452608[0]+work.quad_273478123520[0]+work.quad_833971425280[0]+work.quad_81086394368[0]+work.quad_357213134848[0]+work.quad_359950311424[0]+work.quad_786544324608[0]+work.quad_427454472192[0]+work.quad_9091186688[0]+work.quad_937999876096[0];
  return objv;
}
